...
# # NEW, for nuScenes
# # from flwr_baselines.publications.fedavg_mnist import covernet as model
# from flwr_baselines.publications.fedavg_mnist import covernet
# # TODO: In a similar way, change below. Might do this change directly into _download_data in dataset.py
# # OLD, for FL
# # from flwr_baselines.publications.fedavg_mnist.dataset import load_datasets
# # NEW, for nuScenes
# #from flwr_baselines.publications.fedavg_mnist.datasetNuScenes import load_datasets
# from flwr_baselines.publications.fedavg_mnist import datasetNuScenes  

# # Hannes testing for reimporting 
# import importlib
# importlib.reload(covernet)
# import covernet as model
# # importlib.reload(load_datasets)
# importlib.reload(datasetNuScenes)
# from datasetNuScenes import load_datasets

# TESTING TO RENAME THE FILES
# OLD, for FL
# import importlib
from flwr_baselines.publications.fedavg_mnist import model
from flwr_baselines.publications.fedavg_mnist import dataset # import load_datasets
